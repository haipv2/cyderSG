        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              ...
              <h3 class="profile-username text-center">Sherine Chng</h3>

              <p class="text-muted text-center">Managing Director</p>
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <p class="text-muted">
                Master in Business Administration (MBA), SMU
              </p>
              ...
              <p>
                ...
                <span class="label label-danger">Project Management</span>
                <span class="label label-success">Business Consulting</span>
                <span class="label label-info">Software Sales</span> 
              </p>
