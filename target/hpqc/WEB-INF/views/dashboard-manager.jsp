...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <!-- Logo -->
    <a href="dashboard-manager.html" class="logo">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Sherine Chng</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                ...
                <p>
                  Sherine Chng - Managing Director
                  <small>Joined since Jan 2006</small>
                </p>
              </li>
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="profile-manager" class="btn btn-default btn-flat">Profile</a>
                </div>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        <li class="header">MAIN NAVIGATION</li>
         ...
         <!-- /.Timesheet -->
        <li class="treeview">
          <a href="timesheet/approval.html">
      ...
      <div class="row">
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <h3>Timesheet</h3> 
              <p>You've got 2 to review</p>
            </div>
            <div class="icon">
              <i class="ion ion-bag"></i>
            </div>
            <a href="#" class="small-box-footer">Review now <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="box box-success">
            ...
            <div class="box-body chat" id="chat-box">
              ...
              <div class="item">
                ...
                <p class="message">
                  <a href="#" class="name">
                    <small class="text-muted pull-right"><i class="fa fa-clock-o"></i> 30 October 2016 17:00</small>
                    Stephen Chew
                  </a>
                  IBM Business Process Manager v8.5.5 is out, we need to migrate our system
                </p>
              </div>
              <!-- /.item -->
